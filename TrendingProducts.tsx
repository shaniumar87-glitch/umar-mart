...
export const TrendingProducts: React.FC<TrendingProductsProps> = ({
  ...
  return (
    <section id="trending" className="py-16 bg-slate-50 border-b border-slate-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 gap-4">
          ...
          <p className="text-xs text-slate-500 max-w-md">
            Items experiencing rapid order volume and top shopper ratings across UmarMart over the past 24 hours.
          </p>
        </div>
